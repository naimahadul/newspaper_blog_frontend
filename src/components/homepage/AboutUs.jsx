  ...
  return (
    <div className="bg-white p-6 rounded shadow">
      ...
      <p className="text-lg text-gray-700 mb-4">
        ...
        technology, travel, lifestyle, or any other topic, you widell find something
        that piques your interest here.
      </p>
      <p className="text-lg text-gray-700 mb-4">
      ...
      <Link to="/about" className="text-blue-500 hover:underline inline-block">
        Learn more about us
      </Link>
    </div>
  );
